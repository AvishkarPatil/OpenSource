...
import { Lightbulb, GitBranch, GraduationCap, Loader2, CheckCircle, Home } from 'lucide-react';
import { useSearchParams, useRouter } from 'next/navigation';
import { db } from '@/lib/firebase';
import { collection, addDoc, serverTimestamp } from 'firebase/firestore';
import Link from 'next/link';

const MentorConnectForm = () => {
  ...
  // Auto-fill the issueID from URL query parameter
  useEffect(() => {
    ...
    // Simulate fetching user name from GitHub
    // In a real app, you would fetch this from your auth provider or GitHub API
    setTimeout(() => {
      setName("GitHub User");
    }, 300);
  }, [searchParams]);
          ...
          >
            ...
            <div>
              ...
              <div className="flex items-center">
                <GitBranch className="absolute ml-3 text-gray-500" size={18} />
                <input
                  type="text"
                  id="issueId"
                  value={issueId}
            ...
            <div>
              ...
              <div className="flex items-center">
                <Lightbulb className="absolute ml-3 text-gray-500" size={18} />
                <textarea
                  id="helpType"
                  value={helpType}
            ...
            {/* Submit Button with Visual Feedback - Updated gradient colors */}
            <button
              type="submit"
...
export default MentorConnectForm;